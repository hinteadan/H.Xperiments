...
using H.Xperiments.Couchbase.BLL.Querying;
using LiteDB;
using System;
...
namespace H.Xperiments.Couchbase.BLL
{
    public class CouchbaseOperations : IDisposable
    {
        ...
        public SelectOperationResult<T> SelectCustom<T>(params Expression<Func<T, object>>[] selectors) => operationScope.SelectCustom<T>(selectors);
